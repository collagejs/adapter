...
1. Create `CorePiece` objects from Svelte components.
2. Consume `CorePiece` objects (built with any framework or library) in Svelte projects.
...
1. Install packages:
    ```bash
    npm install @collagejs/svelte @collagejs/vite-css
    ```
